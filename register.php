...
<html>
  <head>
    ...
    <title>Register - InventarisKu</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="text-left form-validate" action="" method="POST" autocomplete="off">
...
if(isset($_POST['submit'])) {
  ...
  $query = mysqli_query($conn, "INSERT INTO user (user_id, name, email, password, active, code) VALUES ('', '$_POST[username]', '$_POST[email]', '$pw', 'T', '$code')");

  $to      = $_POST['email'];
  $subject = "Aktivasi Akun Anda";
  $txt     = "Klik link berikut untuk mengaktifkan akun: <br />";
  $txt     .= "<a href='confirm.php?email=".$_POST['email']."&code=$code&username=".$_POST['username']."'>confirm.php?email=".$_POST['email']."&code=$code</a>";
  $header  = "From: inventarisku@localhost.com";

  $kirim  = mail($to,$subject,$txt,$header);

  if($kirim AND $query) {
    echo "<p>Berhasil Dikirim</p>";
  } else {
