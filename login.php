          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="POST" class="form-validate" action="login_proses.php">
                    ...
                    <div class="form-group">
                      <input id="pw" type="password" name="pw" required data-msg="Please enter your password" class="input-material">
                      <label for="pw" class="label-material">Password</label>
                    </div>
